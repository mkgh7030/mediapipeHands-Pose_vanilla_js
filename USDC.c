...
Project : Speed Control of DC Motor using Ultrasonic Sensor
Version : 1.00
Date    : 5/20/2018
Author  : Sina Keshavarz (@Sina_Dreamer)
Company : IUT
Comments: For academic course project
...
#define k PINC.5
float last_error,last_iterm,iterm,dterm,pterm,output=0;
//float pterm,error=0;
float power=50;
int timer;
int d = 0;
